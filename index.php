...
<head>
    ...
    <style>
        ...
        * {
        ...
        .dashboard-block.spab::before {
            background: linear-gradient(90deg, var(--primary), #0a5cad);
        }

        .dashboard-block.destana::before {
            background: linear-gradient(90deg, var(--secondary), #ff6b3d);
        }
        ...
        .dashboard-block.spab .block-icon {
            background: linear-gradient(135deg, var(--primary) 0%, #032d5e 100%);
        }

        .dashboard-block.destana .block-icon {
            background: linear-gradient(135deg, var(--secondary) 0%, #c43e15 100%);
        }
        ...
        .breakdown-card .breakdown-header.primary {
            background: linear-gradient(135deg, var(--primary) 0%, #032d5e 100%);
        }

        .breakdown-card .breakdown-header.secondary {
            background: linear-gradient(135deg, var(--secondary) 0%, #c43e15 100%);
        }

        .breakdown-card .breakdown-body {
            padding: 10px 0;
        }
